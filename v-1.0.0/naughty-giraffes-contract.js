var naughty_g_provider, naughty_g_accounts, naughty_g_signer, naughty_g_sale_stage;
        ...
        if (typeof naughty_g_signer._isSigner != "undefined" && naughty_g_signer._isSigner === true) {
            ...
            if (naughty_g_accounts.length > 0) {
                ...
                if(ALREADY_MINTED_TOKEN + mint_val > max_mint_token){
                    Swal.fire('Warning !!', 'You have exceeded the mint limit, Max mint limit for '+naughty_g_sale_stage+' sale is '+max_mint_token, 'warning');
                }else {
