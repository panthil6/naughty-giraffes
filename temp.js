...
const NAUGHTY_G_CONTRACT_ADDRESS = '0xd237627daa7d933365585a077a3a13185012f828';
...
async function mintSale() {
    try {
        if (naughty_g_accounts.length > 0 && typeof naughty_g_signer != "undefined" && typeof naughty_g_signer._isSigner != "undefined" && naughty_g_signer._isSigner === true) {
            ...
            let pre_sale_time = new Date((new Date('May 12 13:00:00 UTC 2022').toLocaleString('en-US', {timeZone: 'America/New_York'}))).getTime();
